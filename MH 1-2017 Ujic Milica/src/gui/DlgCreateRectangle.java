...
public class DlgCreateRectangle extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DlgCreateRectangle dialog = new DlgCreateRectangle();
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							if(w <= 0 || h <= 0) {
								throw new Exception("You cannot enter negetive values!");
							}
							dispose();
